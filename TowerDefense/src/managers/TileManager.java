...
public class TileManager {
	...
	private void createTiles() {
		...
		tiles.add(GRASS = new Tile(getSprite(0, 1), id++, GRASS_TILE));
		tiles.add(WATER = new Tile(getAniSprites(3, 0), id++, WATER_TILE));

		roadsS.add(ROAD_LR = new Tile(getSprite(6, 1), id++, ROAD_TILE));
		roadsS.add(ROAD_TB = new Tile(ImgFix.getRotImg(getSprite(6, 1), 90), id++, ROAD_TILE));

		roadsC.add(ROAD_B_TO_R = new Tile(getSprite(6, 2), id++, ROAD_TILE));
		roadsC.add(ROAD_L_TO_B = new Tile(ImgFix.getRotImg(getSprite(7, 1), 90), id++, ROAD_TILE));
		roadsC.add(ROAD_L_TO_T = new Tile(ImgFix.getRotImg(getSprite(6, 3), 180), id++, ROAD_TILE));
		roadsC.add(ROAD_T_TO_R = new Tile(ImgFix.getRotImg(getSprite(6, 3), 270), id++, ROAD_TILE));
		...
		islands.add(TL_ISLE = new Tile(ImgFix.getBuildRotImg(getAniSprites(0, 0), getSprite(7, 1), 0), id++, WATER_TILE));
		islands.add(TR_ISLE = new Tile(ImgFix.getBuildRotImg(getAniSprites(0, 0), getSprite(7, 1), 90), id++, WATER_TILE));
		islands.add(BR_ISLE = new Tile(ImgFix.getBuildRotImg(getAniSprites(0, 0), getSprite(7, 1), 180), id++, WATER_TILE));
		islands.add(BL_ISLE = new Tile(ImgFix.getBuildRotImg(getAniSprites(0, 0), getSprite(7, 1), 270), id++, WATER_TILE));
