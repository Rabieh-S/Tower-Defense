...
public class Toolbar extends Bar {
	...
	private ButtonModel bMenu, bSave;
	private ButtonModel bPathStart, bPathEnd;
	private BufferedImage pathStart, pathEnd;
	private Tile selectedTile;

	private Map<ButtonModel, ArrayList<Tile>> map = new HashMap<ButtonModel, ArrayList<Tile>>();

	private ButtonModel bGrass, bWater, bRoadS, bRoadC, bWaterC, bWaterB, bWaterI;
	private ButtonModel currentButton;
	...
	private void initButtons() {
		...
		bSave = new ButtonModel("Save", 2, 674, 100, 30);
		...
		bGrass = new ButtonModel("Grass", xStart, yStart, w, h, i++);
		bWater = new ButtonModel("Water", xStart + xOffset, yStart, w, h, i++);
		...
		bPathStart = new ButtonModel("PathStart", xStart, yStart + xOffset, w, h, i++);
		bPathEnd = new ButtonModel("PathEnd", xStart + xOffset, yStart + xOffset, w, h, i++);

	}

	private void initMapButton(ButtonModel b, ArrayList<Tile> list, int x, int y, int xOff, int w, int h, int id) {
		b = new ButtonModel("", x + xOff * id, y, w, h, id);
		map.put(b, list);
	}
...
//		bPathEnd.draw(g);
	...
	private void drawPathButton(Graphics g, ButtonModel b, BufferedImage img) {
	...
	private void drawNormalButton(Graphics g, ButtonModel b) {
	...
	private void drawMapButtons(Graphics g) {
		for (Map.Entry<ButtonModel, ArrayList<Tile>> entry : map.entrySet()) {
			ButtonModel b = entry.getKey();
